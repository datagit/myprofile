...
use DataSourceBundle\Form\ActivityType;
...
class ActivityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DataSourceBundle:Activity')->findAll();

        return $this->render('DataSourceBundle:Activity:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DataSourceBundle:Activity:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DataSourceBundle:Activity')->find($id);
        ...
        return $this->render('DataSourceBundle:Activity:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DataSourceBundle:Activity:edit.html.twig', array(
            'entity'      => $entity,
